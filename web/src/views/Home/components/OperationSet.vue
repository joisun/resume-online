...
<template>
  <div class="text-gray-400 top-64 right-60 fixed lg:flex flex-col gap-8 z-10 hidden ">
    ...
    <a
      ...
      <div
           class="qr-code rounded-lg p-3 absolute  top-16  bg-white  flex flex-col items-center shadow-lg ">
        <div
             class="w-5 h-5 bg-white rotate-45 border absolute z-49 top-[-9px] border-b-0 border-r-0"></div>
